...
var text = "";
console.log('  "  " ')
console.log("mainīga vērtība pēc definēšanas");
console.log(text);
...
var radius = 5960;
pi = 3.14;
ekvators = 2 * pi * radius;

document.getElementById("Zemes_lodes_garums").innerHTML = "Zemes ekvatora garums " + ekvators + " km";
console.log("Ekvatora garums = " + ekvators + "km");